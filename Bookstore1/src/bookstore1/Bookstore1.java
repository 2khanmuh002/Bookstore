...
public class Bookstore1 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //Button functions         *will need to be changed so customer info is read off file
      ...
      //Buy screen
         ...
         //Label buy2 = new Label("Your total points is " + PointBuy());
...
//        buysc = new Scene(layout3,200,125);
        ...
        button11.setOnAction(e -> {
            Buy();
            buysc = initializeCustomerStartScene();
        ...
        button12.setOnAction(e -> window.setScene(buysc));
        ...
        vvvBox.getChildren().addAll(table3,hhhBox);
    ...
    private Scene initializeCustomerStartScene(){ 
        ...
        checkOutLogoutBtn.setOnAction(e -> window.setScene(login));
    ...
    //create a method to initialize the customer-cost scene and the cust-start scene
    public Double Buy(){
